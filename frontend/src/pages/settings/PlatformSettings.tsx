    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 shadow dark:shadow-slate-900/50 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">License Enforcement</h2>

          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-slate-900 dark:text-white">Require License Key</h3>
              ...
              <button
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 ${
                  licenseEnforced ? 'bg-primary-600' : 'bg-slate-200 dark:bg-slate-600'
                }`}
              >
                <span
            ...
            {licenseEnforced && (
              <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                <div className="flex">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-yellow-800 dark:text-yellow-300">License Required</h4>
            ...
            {!licenseEnforced && (
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-blue-800 dark:text-blue-300">Free Mode Active</h4>
        ...
        {/* Analytics Section */}
        <div className="bg-white dark:bg-slate-800 shadow dark:shadow-slate-900/50 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Google Analytics</h2>

          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-slate-900 dark:text-white">Enable Google Analytics</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              ...
              <button
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 ${
                  analyticsEnabled ? 'bg-primary-600' : 'bg-slate-200 dark:bg-slate-600'
                }`}
              >
                <span
                  className={`pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 ${
            ...
            {analyticsEnabled && (
              <div>
                <label htmlFor="googleAnalyticsId" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                ...
                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                  Get your ID from: <a href="https://analytics.google.com" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Google Analytics</a> → Admin → Data Streams → Web → Measurement ID
                </p>
              </div>
            )}
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 shadow dark:shadow-slate-900/50 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Instance Information</h2>

          <div className="space-y-4">
            <div>
              <label htmlFor="instanceName" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Instance Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="instanceDescription" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
                Description
              </label>
              <textarea

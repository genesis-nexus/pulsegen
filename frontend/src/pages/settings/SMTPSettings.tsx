    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="card mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">SMTP Configurations</h2>
          <button
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-semibold">{config.host}:{config.port}</h3>
                    {config.isDefault && (
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="card max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">Add SMTP Server</h2>
              <button
                onClick={() => {
                  setShowAddForm(false);
                  resetForm();
      ...
      <div className="card bg-blue-50 border-blue-200">
        <h3 className="font-semibold mb-2">Common SMTP Settings</h3>

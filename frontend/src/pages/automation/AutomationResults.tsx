  ...
  const loadData = async () => {
    try {
      ...
      const [surveyData, analyticsData, statusData] = await Promise.all([
        api.get(`/surveys/${surveyId}`).then(res => res.data.data || res.data),
        api.get(`/analytics/surveys/${surveyId}`).then(res => res.data.data || res.data),
